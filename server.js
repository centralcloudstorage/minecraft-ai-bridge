...
wss.on('connection', (ws, req) => {
  ...
  ws.on('message', async (data) => {
    try {
      ...
      // Handle regular PlayerMessage
      else if (body.eventName === 'PlayerMessage' && body.type !== 'title') {
...
function buildContext(npcName, personality, friendship, romance, playerName, requestType) {
  ...
  const personalityTraits = {
    ...
    curious: "You're always learning new things.",
    loyal: "You're fiercely loyal to friends.",
    materialistic: "You love valuable things.",
    spiritual: "You think deeply about life.",
    pragmatic: "You're practical and down-to-earth.",
    nostalgic: "You often think about the good old days.",
    proud: "You take pride in yourself.",
    fearful: "You worry about dangers.",
    altruistic: "You care about helping others.",
    lazy: "You prefer taking it easy.",
    clumsy: "You're accident-prone but lovable.",
    intellectual: "You enjoy deep conversations.",
    charming: "You're smooth and charismatic.",
    naive: "You trust others easily."
  };
  ...
  if (requestType === "I") {
    context += "The player is interacting with you. Respond warmly. ";
  }
  
  context += "Keep responses natural and under 40 words. Stay in character!";
